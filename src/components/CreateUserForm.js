...
const CreateUserForm = ({ departments, onSubmit, onCancel }) => {
      ...
      <div className="form-container">
        ...
        <form onSubmit={handleFormSubmit} className="create-user-form">
          {[
            ...
            { label: "Numéro d'adresse", name: 'num_address' },
            { label: 'Rue', name: 'street_address' },
            { label: 'Ville', name: 'city_address' },
            { label: 'Code postal', name: 'area_code_address' },
            { label: 'Région', name: 'region_address' },
            { label: 'Pays', name: 'country_address' },
          ].map((field) => (
